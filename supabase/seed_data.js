 ...
 *
 * Run: cd nextjs && node ../supabase/seed_data.js
 */
const { createClient } = require('@supabase/supabase-js');

const supabaseUrl = 'https://zuhhimmdlnsjuwksitpb.supabase.co';
const serviceRoleKey = 'SUPABASE_SERVICE_ROLE_KEY_REMOVED';
...
const templates = [
  {
    slug: 'widerspruch',
    title: 'Widerspruch gegen einen Bescheid (Objection to an Administrative Decision)',
    category: 'public',
    ...
    placeholders: ['name', 'opposing_party', 'court_name', 'case_number', 'incident_date', 'notes']
  },
  {
    slug: 'mahnung',
    ...
    placeholders: ['name', 'opposing_party', 'court_name', 'case_number', 'incident_date', 'deadline_date', 'dispute_value', 'notes']
  },
  {
    slug: 'kuendigung',
  ...
  },
  {
    ...
    placeholders: ['name', 'opposing_party', 'court_name', 'case_number', 'incident_date', 'dispute_value', 'notes']
  }
];
