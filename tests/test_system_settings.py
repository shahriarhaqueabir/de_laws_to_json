...
def test_ai_status():
    ...
    if success:
        ...
        print(f"   Search Index: {data.get('dependencies', {}).get('search_index', 'unknown')}")
...
def test_admin_info():
    ...
    success, data, elapsed = test_endpoint("GET", "/api/admin/info", expected_status=403)
...
def test_rebuild_index_endpoint():
    ...
    success, data, elapsed = test_endpoint("POST", "/api/admin/rebuild_index", expected_status=403)
