...
class TestAntiHallucination(unittest.TestCase):
    ...
    def test_hallucinated_citation_removed(self):
        ...
        sanitized, warnings = sanitize_ai_response(response_hallucinated, self.test_context)
...
class TestDisclaimer(unittest.TestCase):
    ...
    def test_disclaimer_detection(self):
        ...
        with_disclaimer = "The law states... ⚖️ This information does not constitute legal advice."
